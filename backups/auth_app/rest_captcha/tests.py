...
class RestCaptchaTests(TestCase):
    ...
    def setUp(self):
        AdminLoginLock.objects.create(ip='127.0.0.1', num_of_retry=100)

    def test_views(self):
        result = self.client.get(reverse('rest_captcha')).json()
...
class ImageGenTests(TestCase):
    ...
    def test_image(self):
        ...
        with open('auth_app/rest_captcha/captcha_py3.png', 'wb') as f:
            f.write(image)
